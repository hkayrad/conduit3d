...
> **_DON'T CHECK THE PERFORMANCE WHILE THE NETWORK TAB IS OPEN IN THE DEV TOOLS, IT CAUSES MAJOR PERFORMANCE PROBLEMS WHILE LOADING TILES FROM THE SERVER_**
...
- _Natively using the GPU currently does not work for creating extruded column layers._
