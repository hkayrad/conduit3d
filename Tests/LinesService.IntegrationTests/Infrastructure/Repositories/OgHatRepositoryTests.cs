...
public class OgHatRepositoryTests : IAsyncLifetime
{
    private readonly ITestOutputHelper _output;
    private readonly PostgreSqlContainer _postgresContainer;
    private IServiceProvider _serviceProvider = null!;

    public OgHatRepositoryTests(ITestOutputHelper output)
    {
        _output = output;
    ...
    public async Task InitializeAsync()
    {
        ...
        services.AddScoped<IOgHatRepository, OgHatRepository>();
    ...
    public async Task GetByIdAsync_WhenExists_ShouldReturnEntityWithWkb()
    {
        ...
        {
            // Act
            var result = await scope.ServiceProvider.GetRequiredService<IOgHatRepository>()
    ...
    public async Task GetAllAsync_ShouldReturnAllEntitiesWithWkb()
    {
        ...
        {
            // Act
            var results = await scope.ServiceProvider.GetRequiredService<IOgHatRepository>()
    ...
    public async Task GetCountAsync_ShouldReturnCount()
    {
        ...
        {
            // Act
            var count = await scope.ServiceProvider.GetRequiredService<IOgHatRepository>()
    ...
    public async Task GetTipListAsync_ShouldReturnDistinctTypes()
    {
        ...
        {
            // Act
            var types = await scope.ServiceProvider.GetRequiredService<IOgHatRepository>()
