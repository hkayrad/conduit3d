...
public class AgDirekRepositoryTests : IAsyncLifetime
{
    private readonly ITestOutputHelper _output;
    private readonly PostgreSqlContainer _postgresContainer;
    private IServiceProvider _serviceProvider = null!;

    public AgDirekRepositoryTests(ITestOutputHelper output)
    {
        _output = output;
    ...
    public async Task InitializeAsync()
    {
        ...
        services.AddScoped<IAgDirekRepository, AgDirekRepository>();
        ...
        try
        {
            ...
            await context.Database.ExecuteSqlRawAsync(@"
                INSERT INTO ""SBK_AGDIREK""(geometry, kodu, adi, cinsi, tipi, direk_no, boy_ozellik, direk_boy_id)
