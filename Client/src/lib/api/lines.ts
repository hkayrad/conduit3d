...
export class AgHatApi {
	...
	static async fetchTypes() {
		try {
			const response = await instance.get<ApiResponse<string[]>>("agHat/types");
			return response.data;
		} catch (error) {
...
export class OgHatApi {
	...
	static async fetchTypes() {
		try {
			const response = await instance.get<ApiResponse<string[]>>("ogHat/types");
			return response.data;
		} catch (error) {
...
export class RekortmanApi {
	...
	static async fetchTypes() {
		try {
			const response = await instance.get<ApiResponse<string[]>>("rekortman/types");
			return response.data;
		} catch (error) {
