...
internal sealed class TokenProvider
{
    ...
    {
        var expirationTimeHrs = int.TryParse(Environment.GetEnvironmentVariable("JWT_EXPIRATION_TIME_HRS"), out var hrs) ? hrs : throw new InvalidOperationException("JWT_EXPIRATION_TIME_HRS environment variable is not set.");
        ...
        var secretKey = Environment.GetEnvironmentVariable("JWT_SECRET") ?? throw new InvalidOperationException("JWT_SECRET environment variable is not set.");
