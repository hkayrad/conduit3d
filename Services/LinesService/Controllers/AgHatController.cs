...
namespace LinesService.Controllers
{
    ...
    public class AgHatController(IAgHatService agHatService) : ControllerBase
    {
        ...
        [MapToApiVersion("1.0")]
        [HttpPost]
        public async Task<Response<AgHat>> CreateAsync([FromBody] AgHatDto dto, CancellationToken cancellationToken)
        {
            var entity = new AgHat
            {
            ...
            return await _agHatService.CreateAsync(entity, cancellationToken);
        }
        ...
        {
            return await _agHatService.DeleteAsync(id, cancellationToken);
        }

        [MapToApiVersion("1.0")]
        [HttpPut("{id}")]
        public async Task<Response<AgHat>> UpdateAsync(int id, [FromBody] AgHatDto dto, CancellationToken cancellationToken)
        {
            var entity = new AgHat
            {
                Id = id,
            ...
            return await _agHatService.UpdateAsync(entity, cancellationToken);
        }
    }
}
