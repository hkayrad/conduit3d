...
namespace LinesService.Controllers
{
    ...
    public class OgHatController(IOgHatService ogHatService) : ControllerBase
    {
        ...
        [MapToApiVersion("1.0")]
        [HttpPost]
        public async Task<Response<OgHat>> CreateAsync([FromBody] OgHatDto dto, CancellationToken cancellationToken)
        {
            var entity = new OgHat
            {
            ...
            return await _ogHatService.CreateAsync(entity, cancellationToken);
        }
        ...
        {
            return await _ogHatService.DeleteAsync(id, cancellationToken);
        }

        [MapToApiVersion("1.0")]
        [HttpPut("{id}")]
        public async Task<Response<OgHat>> UpdateAsync(int id, [FromBody] OgHatDto dto, CancellationToken cancellationToken)
        {
            var entity = new OgHat
            {
                Id = id,
            ...
            return await _ogHatService.UpdateAsync(entity, cancellationToken);
        }
    }
}
