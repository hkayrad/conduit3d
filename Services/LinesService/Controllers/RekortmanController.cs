...
namespace LinesService.Controllers
{
    ...
    public class RekortmanController(IRekortmanService rekortmanService) : ControllerBase
    {
        ...
        public async Task<RekortmanResponse> GetAllAsProtobufAsync(
            [FromQuery] int pageNumber = 1,
            [FromQuery] int pageSize = 100000,
            [FromQuery] string sortBy = "Id",
            [FromQuery] bool ascending = true,
        ...
        {
            return await _rekortmanService.GetAllAsProtobufAsync(pageNumber,
                                                    pageSize,
                                                    sortBy,
                                                    ascending,
                                                    extent,
        ...
        [MapToApiVersion("1.0")]
        [HttpPost]
        public async Task<Response<Rekortman>> CreateAsync([FromBody] RekortmanDto dto, CancellationToken cancellationToken)
        {
            var entity = new Rekortman
            {
            ...
            return await _rekortmanService.CreateAsync(entity, cancellationToken);
        }
        ...
        {
            return await _rekortmanService.DeleteAsync(id, cancellationToken);
        }

        [MapToApiVersion("1.0")]
        [HttpPut("{id}")]
        public async Task<Response<Rekortman>> UpdateAsync(int id, [FromBody] RekortmanDto dto, CancellationToken cancellationToken)
        {
            var entity = new Rekortman
            {
                Id = id,
            ...
            return await _rekortmanService.UpdateAsync(entity, cancellationToken);
        }
    }
}
