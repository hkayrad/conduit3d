...
namespace PolesService.Controllers
{
    ...
    public class AgDirekController(IAgDirekService agDirekService) : ControllerBase
    {
        ...
        {
            return await _agDirekService.GetCountAsync(extent, query, cancellationToken);
        }
        ...
        [MapToApiVersion("1.0")]
        [HttpPost]
        public async Task<Response<AgDirek>> CreateAsync([FromBody] AgDirekDto dto, CancellationToken cancellationToken)
        {
            var entity = new AgDirek
            {
            ...
            return await _agDirekService.CreateAsync(entity, cancellationToken);
        }
        ...
        {
            return await _agDirekService.DeleteAsync(id, cancellationToken);
        }

        [MapToApiVersion("1.0")]
        [HttpPut("{id}")]
        public async Task<Response<AgDirek>> UpdateAsync(int id, [FromBody] AgDirekDto dto, CancellationToken cancellationToken)
        {
            var entity = new AgDirek
            {
                Id = id,
            ...
            return await _agDirekService.UpdateAsync(entity, cancellationToken);
        }
    }
}
