...
namespace PolesService.Controllers
{
    ...
    public class AydDirekController(IAydDirekService aydDirekService) : ControllerBase
    {
        ...
        [MapToApiVersion("1.0")]
        [HttpPost]
        public async Task<Response<AydDirek>> CreateAsync([FromBody] AydDirekDto dto, CancellationToken cancellationToken)
        {
            var entity = new AydDirek
            {
            ...
            return await _aydDirekService.CreateAsync(entity, cancellationToken);
        }
        ...
        {
            return await _aydDirekService.DeleteAsync(id, cancellationToken);
        }

        [MapToApiVersion("1.0")]
        [HttpPut("{id}")]
        public async Task<Response<AydDirek>> UpdateAsync(int id, [FromBody] AydDirekDto dto, CancellationToken cancellationToken)
        {
            var entity = new AydDirek
            {
                Id = id,
            ...
            return await _aydDirekService.UpdateAsync(entity, cancellationToken);
        }
    }
}
