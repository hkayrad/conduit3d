...
public class PostgresqlAgDirekService(IUnitOfWork unitOfWork) : IAgDirekService
{
    ...
    public async Task<Response<List<AgDirek>>> GetAllAsync(int pageNumber, int pageSize, string sortBy, bool ascending, Extent? extent, CancellationToken cancellationToken)
    {
