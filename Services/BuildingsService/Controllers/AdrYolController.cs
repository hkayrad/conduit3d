...
namespace BuildingsService.Controllers
{
    ...
    public class AdrYolController(IAdrYolService adrYolService) : ControllerBase
    {
        ...
        [MapToApiVersion("1.0")]
        [HttpPost]
        public async Task<Response<AdrYol>> CreateAsync([FromBody] AdrYolDto dto, CancellationToken cancellationToken)
        {
            var entity = new AdrYol
            {
                Id = 0, // Generated by DB
                Genislik = dto.Genislik,
                SeritSayisi = dto.SeritSayisi,
                Yapisi = dto.Yapisi,
                Tipi = dto.Tipi,
                Kodu = dto.Kodu,
                Adi = dto.Adi,
            ...
            return await _adrYolService.CreateAsync(entity, cancellationToken);
        }
        ...
        {
            return await _adrYolService.DeleteAsync(id, cancellationToken);
        }

        [MapToApiVersion("1.0")]
        [HttpPut("{id}")]
        public async Task<Response<AdrYol>> UpdateAsync(int id, [FromBody] AdrYolDto dto, CancellationToken cancellationToken)
        {
            var entity = new AdrYol
            {
                Id = id,
            ...
            return await _adrYolService.UpdateAsync(entity, cancellationToken);
        }
    }
}
